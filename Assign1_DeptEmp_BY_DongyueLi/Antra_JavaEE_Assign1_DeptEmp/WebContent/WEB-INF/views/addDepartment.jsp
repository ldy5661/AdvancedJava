		...
		<c:when test="${not empty invalidUser and !invalidUser }">
			<div class="container">
				<div class="row justify-content-end" style="margin: 5%;">
					<div class="col-1">
						<a href="/Antra_JavaEE_Assign1_DeptEmp/logout"
				...
				<form action="/Antra_JavaEE_Assign1_DeptEmp/addDept" method="post">
						...
						<table class="table table-striped">
							...
							<tbody>
								<c:forEach items="${empList}" var="emp">
									<tr>
										<td><input type="checkbox" name="empID" value="${emp.id}" />
										<td>${emp.id}</td>
										<td>${emp.firstName }</td>
										<td>${emp.lastName }</td>
										<td>${emp.age }</td>
					...
					<div class="form-group row justify-content-md-center"
						...
						<div class="col-2">
							<a href="/Antra_JavaEE_Assign1_DeptEmp/loggedin" class="btn btn-danger">
