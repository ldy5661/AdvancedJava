		...
		<c:when test="${not empty invalidUser and !invalidUser }">
			<div class="container">
				<div class="row justify-content-end" style = "margin: 5%;">
					<div class="col-1">
						<a href = "/Antra_JavaEE_Assign2_DeptEmp_JDBC/logout" class="btn btn-info btn-lg">
				...
				<table class = "table text-center" style = "margin-top: 5%;">
					<tr>
						<td><h3><a href="/Antra_JavaEE_Assign2_DeptEmp_JDBC/addDept">Add Department</a></h3></td>
					</tr>
					<tr>
						<td><h3><a href="/Antra_JavaEE_Assign2_DeptEmp_JDBC/addEmp">Add Employee</a></h3></td>
					</tr>
				</table>
